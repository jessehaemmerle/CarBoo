...
show_help() {
    ...
    echo "  ./docker-start.sh debug-frontend - Start frontend debug mode with enhanced logging"
    echo "  ./docker-start.sh fix-frontend   - Apply frontend fixes and rebuild"
    ...
    echo ""
    echo "🔧 Debug commands:"
    echo "  ./debug-frontend.sh              - Diagnose frontend container issues"
    echo "  ./debug-mongodb-health.sh        - Diagnose MongoDB health issues"
